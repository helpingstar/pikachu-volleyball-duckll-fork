# This is a repository that forked [DuckLL/pikachu-volleyball](https://github.com/DuckLL/pikachu-volleyball), which is a fork of [gorisanson/pikachu-volleyball](https://github.com/gorisanson/pikachu-volleyball).

This repository was created for the purpose of reinforcement learning research and is not intended for deploy.

The changes are as follows:
1. `state` and `observation` information is displayed at the bottom of the game screen.
2. Removed in-game sound and audio, including `"pixi-sound"` in `package.json`.
